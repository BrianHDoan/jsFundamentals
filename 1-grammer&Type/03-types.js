...
console.log(car1); // {color: 'red', tires: 4, extras: 'A/C and Radio'}
...
console.log(typeof burritos); //objects

/*
Addition vs. Concatenation
**************************
When JS sees code combining two or more numbers, it adds the values together using the built-in math 
functionality;
 when it sees code adding together one or more strings, it changes and the plus sign becomes an 
 assignment operator-
...
let firstName = 'Brian';
let lastName = 'Doan';
let houseNumber = 8417;
let street = 'Stark Drive';
let city = 'Indianapolis';
let state = 'IN';
let zipcode = 46216;
let wholeAddress = (firstName +" "+ lastName +" "+ houseNumber +" "+ street +" "+ city +", "+ state +", "+ zipcode);
